...
_lr_productions = [
  ...
  ('expression -> expression PLUS term','expression',3,'p_expression_plus','parser_1.py',9),
  ('expression -> expression MINUS term','expression',3,'p_expression_minus','parser_1.py',13),
  ('expression -> term','expression',1,'p_expression_term','parser_1.py',17),
  ('term -> term TIMES factor','term',3,'p_term_times','parser_1.py',21),
  ('term -> term DIVIDE factor','term',3,'p_term_div','parser_1.py',25),
  ('term -> factor','term',1,'p_term_factor','parser_1.py',29),
  ('factor -> NUMBER','factor',1,'p_factor_num','parser_1.py',33),
  ('factor -> LPAREN expression RPAREN','factor',3,'p_factor_expr','parser_1.py',37),
]
